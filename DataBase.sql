...
INSERT INTO `admins` (`id`, `name`, `username`, `email`, `password`, `is_super`, `image`, `phone`, `address`, `created_at`)
VALUES
	(1,'admin','admin','admin@gmail.com','example@Password.Energyz',0,'63134ebae203c1662209722.jpg','123456789','london','Kb0wZOqcTvvhQtYmyv8DSiFuEgtqu3QxGCZNNDthzWqjz6bMWVclKbi6h3e8','2021-03-08 12:58:38','2022-09-03 06:55:22');
...
CREATE TABLE wall_insulation (
    ...
    PRIMARY KEY (inspector_id, property_id)
);
...
CREATE TABLE aid_estimation (
    ...
    household_size INT, -- Number of people in the household including the inspector
